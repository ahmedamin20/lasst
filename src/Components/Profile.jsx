                    ...
                    <div className="back-color rounded-lg d-block d-sm-flex">
                        ...
                        <div className="tab-content p-4 p-md-5" id="v-pills-tabContent">
                            ...
                            >
                                ...
                                <p className="text-muted">
                                    View your played matches and see the ratings on it.
                                </p>
                                    ...
                                    <div className="row">
                                        ...
                                        >
                                            <img
                                                ...
                                                alt="..."
                                            />
                                            <div className="card-body fw-bolder px-1 my-2">
                                                <h6>Gohary Stadium</h6>
                                                <h6 className="my-1">
                                                    <i className="bx bxs-star" style={{ color: "#ff9800" }} />
                                                    6.5
                                                </h6>
                                                <p className="my-1">
                                                    <i className="bx bxs-watch" style={{ color: "#0a1429" }} />{" "}
                                                    <span>2 Octoper,2023</span> <span>|</span>{" "}
                                                    <span>9:00 PM</span>
                                                </p>
                                                <p className="my-1">
                                                    <i
